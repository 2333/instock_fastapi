...
### 任务清单（草案）
- [ ] P3-01 用户行为埋点与收集（操作日志、筛选使用频次）
- [ ] P3-02 智能推荐服务（基于协同过滤或规则引擎）
- [ ] P3-03 预警规则引擎 + 推送集成
- [ ] P3-04 策略分享功能增强（评分/评论/收藏）
- [ ] P3-05 参数优化服务（异步任务 + 结果对比）
- [ ] P3-06 数据洞察报告生成（定时任务 + 邮件/消息推送）

### 前置条件
- **Phase 0/1/2 全部完成并稳定运行**
- 用户行为数据积累（至少 2 周使用数据）
- 推送通道就绪（消息通知已打通）
