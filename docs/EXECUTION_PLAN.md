...
>
> **当前状态**: `origin/main` 已合入 `PR #8`，但实际合并范围超出 `M0` 边界；当前最高优先级是先执行 `M0 rebaseline`，将主线收回为真正的 `M0` 基线，再启动 `M1`
...
### 任务清单
- [ ] **P3-01 用户行为埋点与收集**（设计文档见 `docs/milestones/phase3/PHASE3_P3-01_USER_EVENTS.md`）
...
- [ ] **P3-03 预警规则引擎 + 推送集成**（设计文档见 `docs/milestones/phase3/PHASE3_P3-03_ALERT_ENGINE.md`）
  - 预警条件：价格/涨跌幅/RSI/形态/资金流向
  - 定时检查任务（5 分钟间隔）+ 应用内通知 + 冷却防骚扰
  - 前端：Alert 管理页 + 通知铃铛 + 关注页快速设置
- [ ] **P3-04 策略分享功能增强**（设计文档见 `docs/milestones/phase3/PHASE3_P3-04_STRATEGY_MARKET.md`）
