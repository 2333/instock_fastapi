...
参考: `QUICKFIX_M1_TUSHARE_TOKEN.md`
...
| 文档 | 路径 | 说明 |
|------|------|------|
| M1 总体执行计划 | `docs/M1_INITIATION_TASKS.md` | 四条工作流、验收标准、风险缓解 |
| 任务详细拆解 | `docs/M1_TASK_BREAKDOWN.md` | 64 项任务，含步骤、输出、验收、工时 |
| 进度跟踪模板 | `docs/M1_PROGRESS_TRACKER.md` | 状态跟踪（todo/in_progress/done/blocked） |
| 启动检查清单 | `docs/M1_KICKOFF_CHECKLIST.md` | 触发条件 → 自动执行序列 → 验收 |
...
| Tushare 阻塞诊断 | `docs/M1_TUSHARE_TOKEN_BLOCK.md` | API 40101 诊断、修复步骤、临时方案 |
| 快速修复指南 | `QUICKFIX_M1_TUSHARE_TOKEN.md` | 3 步快速修复（sed 命令 + 常见问题） |
| **本总览** | `docs/M1_READINESS_SUMMARY.md` |  consolidated readiness state |
...
### 阶段 2: WS-0 第一批任务启动
按 `docs/M1_KICKOFF_CHECKLIST.md` 执行:
...
### 阶段 3: 进度跟踪初始化
- 创建/更新 `docs/M1_PROGRESS_TRACKER.md`
