...
- [M3_P3-03_ALERT_ENGINE_PLAN.md](./M3_P3-03_ALERT_ENGINE_PLAN.md) - 当前 `M3 / P3-03` 的锚定目标、canonical model、分步交付、验收与 PR 收口清单
...
2. 再看 [M3_P3-03_ALERT_ENGINE_PLAN.md](./M3_P3-03_ALERT_ENGINE_PLAN.md)
3. 如果要确认为什么现在可以启动 `M3`，再看 [PRE_M3_DECISION.md](./PRE_M3_DECISION.md)
...
- `Pre-M3` 已在 `2026-04-22` 通过最终 gate，因此这里现在是 `M3 / P3-03` 的执行与验收入口目录
